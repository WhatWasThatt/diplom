...
class ProcessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create processor" do
    assert_difference('Processor.count') do
      post processors_url, params: { processor: { brand: @processor.brand, category: @processor.category, country: @processor.country, crystalcodename: @processor.crystalcodename, description: @processor.description, model: @processor.model, name: @processor.name, price: @processor.price, produced: @processor.produced, socket: @processor.socket } }
    end
  ...
  test "should update processor" do
    patch processor_url(@processor), params: { processor: { brand: @processor.brand, category: @processor.category, country: @processor.country, crystalcodename: @processor.crystalcodename, description: @processor.description, model: @processor.model, name: @processor.name, price: @processor.price, produced: @processor.produced, socket: @processor.socket } }
